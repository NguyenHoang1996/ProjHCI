...
export default class HomeScreenBXHMore extends React.Component {
        ...
        return (
            <View style={{ backgroundColor: "white", justifyContent: "center", alignItems: "center", marginTop: 0 }}>
                ...
                <View style={{
                    ...
                    <Text numberOfLines={1} style={{ fontSize: 16, fontWeight: "bold", color: "white", width: 210 }}>Bảng Xếp Hạng Bài Hát</Text>
                ...
                <ScrollView style={{ marginTop: 0, height: 470, width: "100%" }}>
                    <Text style={{ marginLeft: 16, marginTop: 8, marginBottom: 8, fontSize: 16, fontWeight: "bold" }}>Mới và HOT</Text>
                    <FlatList
